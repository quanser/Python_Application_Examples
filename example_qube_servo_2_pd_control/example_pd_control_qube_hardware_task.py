...
# a physical QUBE Servo 2 device, in a task-based (time-based IO) mode where you do not have to handle timing
# yourself. 
# -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- 
# Pathing imports
import sys
...
myQube = QubeServo2(id='0', hardware=1, readMode=1) # Task Mode (Time-based IO) with Hardware
