...
myCam1 = Camera3D(mode='RGB&DEPTH', frameWidthRGB=imageWidth, frameHeightRGB=imageHeight, frameRateRGB=sampleRate, frameRateDepth=sampleRate,
                                frameWidthDepth=imageWidth, frameHeightDepth=imageHeight, deviceId='0')
...
try:
    while elapsed_time() < simulationTime:
        ...
        cv2.imshow('RGB', myCam1.imageBufferRGB)
        cv2.imshow('Depth', myCam1.imageBufferDepthM)        
